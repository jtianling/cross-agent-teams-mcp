...
export function registerBusinessTools(
  ...
  async function tryCodexPreRegScan(
    ...
    const auto = await autoBindCodexPane({
      ...
      expectedRegisterGeneration,
      targetPaneId,
      // Consuming the nonce is what proves the caller is sitting in the pane
